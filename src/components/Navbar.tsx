      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="h-11 w-11 lg:h-14 lg:w-14 flex items-center justify-center bg-white rounded-full shadow-md border border-steel/20 shrink-0 overflow-hidden">
              <img
