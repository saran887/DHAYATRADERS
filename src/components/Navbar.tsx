...
// Logo served from /public/assets to avoid importing it into the JS graph.
...
export default function Navbar({ onOpenConsultation }: NavbarProps) {
  ...
  return (
    <>
      ...
      <nav
        id="main-navbar"
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-[#0D2136] border-b border-steel/30 shadow-lg ${isScrolled ? 'py-2 lg:py-3' : 'py-3 lg:py-4.5'
          }`}
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="h-12 w-12 lg:h-16 lg:w-16 flex items-center justify-center bg-white rounded-full shadow-md border border-steel/20 shrink-0 overflow-hidden p-1">
              <img
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-[8px] md:text-[9px] text-teal uppercase tracking-widest font-semibold mt-0.5 leading-none">
                Building Prosperity &amp; Trusted Trading             </p>
            </div>
          </Link>
