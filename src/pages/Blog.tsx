  ...
  return (
    <PageTransition>
      <Helmet>
        ...
        <meta name="description" content="Stay updated with industry trends, expert building guides, material selection guides, and Prosperity investment tips in Erode from DHAYATRADERS." />
        <meta name="twitter:card" content="summary_large_image" />
          ...
          <div className="flex flex-wrap gap-2 justify-center mb-10">
            {categories.map(cat => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${selectedCategory === cat
